...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/06/01 09:28:22 by enaboule          #+#    #+#             */
/*   Updated: 2016/06/01 09:51:28 by enaboule         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_draw_select(t_wlf *wlf)
{
	wlf->x_draw = wlf->x;
	wlf->y_draw = 0;
	while (wlf->y_draw < wlf->draw_start && wlf->y_draw < 1000 &&
		wlf->y_draw >= 0)
	{
		ft_draw_sky(wlf);
		wlf->y_draw++;
	...
	while (wlf->y_draw < wlf->draw_end && wlf->y_draw < 1000 &&
		wlf->y_draw >= 0)
	{
		ft_draw_wall(wlf);
		wlf->y_draw++;
	...
	while (wlf->y_draw < wlf->height && wlf->y_draw < 1000 &&
		wlf->y_draw >= 0)
	{
		ft_draw_ground(wlf);
		wlf->y_draw++;
